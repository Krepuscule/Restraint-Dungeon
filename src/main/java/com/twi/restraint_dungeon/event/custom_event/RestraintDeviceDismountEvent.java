...
public class RestraintDeviceDismountEvent extends LivingEvent implements ICancellableEvent{
    private final RestraintDevice device;
    private final Level level;
    private final BlockPos pos;

    public RestraintDeviceDismountEvent(LivingEntity target, RestraintDevice device, Level level , BlockPos pos) {
        super(target);
        this.device = device;
        this.level = level;
        this.pos = pos;
    ...
    public static class Pre extends RestraintDeviceDismountEvent implements ICancellableEvent{
        public Pre(LivingEntity target, RestraintDevice device, Level level,BlockPos pos){
            super(target,device,level,pos);
        }
    }

    public static class Post extends RestraintDeviceDismountEvent{
