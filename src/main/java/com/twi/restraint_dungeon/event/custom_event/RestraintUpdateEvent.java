...
public class RestraintUpdateEvent extends Event {
    ...
    public RestraintUpdateEvent(LivingEntity entity, PlayerRestraintPart part, int index, ItemStack oldStack, ItemStack newStack) {
        this.entity = entity;
        this.part = part;
        this.index = index;
