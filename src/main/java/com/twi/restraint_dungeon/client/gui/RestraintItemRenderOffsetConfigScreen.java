...
import com.twi.restraint_dungeon.network.payload.player_restraint.ServerUpdateRenderOffsetPayload;
...
@OnlyIn(Dist.CLIENT)
public class RestraintItemRenderOffsetConfigScreen extends Screen {
    
    private final Player targetPlayer;
    private static final float MIN_VALUE = -4.0F;
    private static final float MAX_VALUE = 4.0F;

    public RestraintItemRenderOffsetConfigScreen(Player player) {
        super(Component.translatable("gui.restraint_dungeon.title.render_offset_config"));
    ...
    private void updateOffset(PlayerRestraintPart part, float newValue) {
        ...
        ServerUpdateRenderOffsetPayload packet = new ServerUpdateRenderOffsetPayload(part.name(), newValue);
