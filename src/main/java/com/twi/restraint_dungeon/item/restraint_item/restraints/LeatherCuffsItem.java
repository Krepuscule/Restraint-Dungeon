...
public class LeatherCuffsItem extends RestraintItem {

    public static final RestraintDefaults LEATHER_CUFFS_DEFAULTS = new RestraintDefaults(
            200,
            15.0,
            0.25,
            0.5,
    ...
    public LeatherCuffsItem(Properties properties) {
        super(properties.stacksTo(1), LEATHER_CUFFS_DEFAULTS);
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull Item.TooltipContext context, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.restraint_dungeon.tooltips.describe.leather_cuffs").withStyle(ChatFormatting.GRAY));
    }
}