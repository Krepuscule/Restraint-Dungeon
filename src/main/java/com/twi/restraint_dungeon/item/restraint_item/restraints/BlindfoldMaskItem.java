...
public class BlindfoldMaskItem extends RestraintItem {
    ...
    public static final RestraintDefaults BLINDFOLD_DEFAULTS = new RestraintDefaults(
            100,
            30.0,
            0.25,
            0.75,
    ...
    public BlindfoldMaskItem(Properties properties) {
        super(properties.stacksTo(1), BLINDFOLD_DEFAULTS);
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull Item.TooltipContext context, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("item.restraint_dungeon.tooltips.describe.blindfold_mask").withStyle(ChatFormatting.GRAY));
    }
}