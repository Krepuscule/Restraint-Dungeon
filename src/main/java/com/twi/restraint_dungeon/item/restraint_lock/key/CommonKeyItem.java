package com.twi.restraint_dungeon.item.restraint_lock.key;
...
public class CommonKeyItem extends RestraintKeyItem {

    public CommonKeyItem() {
        super(new Properties());
    }

    public void setOwnerData(@NotNull ItemStack stack, @NotNull UUID uuid, @NotNull String name) {

        if (stack.getItem() instanceof CommonKeyItem lockItem) {
    ...
    @Nullable
    public UUID getOwnerUUID(@NotNull ItemStack stack) {
        if (stack.getItem() instanceof CommonKeyItem lockItem) {
    ...
    @NotNull
    public String getOwnerName(@NotNull ItemStack stack) {
